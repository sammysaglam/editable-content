...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_28__, __WEBPACK_EXTERNAL_MODULE_29__) {
...
var _draftConvert = __webpack_require__(29);
	...
	_createClass(EditableContent, [{
		...
		value: function onChange(editorState) {
			...
			if (!selection.isCollapsed && !editorState.getSelection().isCollapsed() && selection.range) {
				...
				var offset = _entry.utils.selection.getSelectionCoords(this.container, selection.range);
		...
		value: function removeCompositeDecorators(editorState) {
			return _draftJs.EditorState.set(editorState, { decorator: null });
		}
	}, {
...
var Link = function (_React$Component) {
	...
	_createClass(Link, [{
		...
		value: function render() {
			...
			var isExternalUrl = target === '_blank' || url.startsWith('http');

			return _react2.default.createElement(
				'span',
				{ ref: 'link' },
				isExternalUrl ? _react2.default.createElement(
					'a',
					{ href: url, onMouseOver: onMouseOver, onMouseLeave: onMouseLeave, target: target },
					children
				) : _react2.default.createElement(
					_reactRouterDom.NavLink,
					{ to: url, onMouseOver: onMouseOver, onMouseLeave: onMouseLeave },
					children
				)
			);
		}
...
var _ImageToolbar = __webpack_require__(63);
...
var _ToolbarIcon = __webpack_require__(26);
...
var BLOCK_TYPES = [{
	...
	label: _react2.default.createElement('img', { src: __webpack_require__(76) })
}, {
	typeId: 'unordered-list-item',
	label: _react2.default.createElement('img', { src: __webpack_require__(77) })
}, {
	typeId: 'code-block',
	label: '<code>'
}];
